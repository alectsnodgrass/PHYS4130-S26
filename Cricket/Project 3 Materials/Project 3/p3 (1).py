...
strag = [] # short for scipy tragectories
rtrag = []
vtrag = []
sarea = []
rarea = []
...
# plot
plt.plot(st, area_s, color = 'red', label="Scipy")
plt.plot(rt, area_r, color = 'green', label="RK45")
plt.plot(vt, area_v, color = 'blue', label="Verlet")

plt.xlabel("Time")
plt.ylabel("Phase Space Area")
plt.title("Phase Space Area vs Time")
plt.legend()
plt.show()
