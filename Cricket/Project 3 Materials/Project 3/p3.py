...
t_v, x_v, v_v = verlet(N_initial, tmin, tmax, nts, lambda x, t: accel(x, v, omega, damping))
...
nt_v, nx_v, nv_v = verlet(N_initial, tmin, tmax, nts, lambda x, t: accel(x, v, omega, damping))
